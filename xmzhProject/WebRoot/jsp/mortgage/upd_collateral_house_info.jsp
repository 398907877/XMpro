...
<h:form name="data_form"  id="data_form" action="/mortgage/mortgageReserveAction_updColl.action"  enctype="multipart/form-data" method="post" >
		<table align="center" border="0" width="100%" class="form_table">
			...
			<tr>
				...
				<h:textarea rows="5"  cols="30"   property="mortgageReserve.remark"   validateAttr="maxLength=125;"/>
				</td>					
			</tr>
			...
			<tr>	
				...
				<td colspan="1" width="30%">
				<h:text id="propertyNo"   iterateId="id3" property="mortgageReserveHouse.propertyNo"  value="${id3.PROPERTYNO }" validateAttr="allowNull=false;maxLength=125;"/><font style="color: red">*</font>
				</td>	
				<td class="form_label" align="right" width="15%">产权人姓名：</td>
				<td colspan="1" width="30%">
				<h:text id="propertyName"   iterateId="id3" property="mortgageReserveHouse.propertyName" value="${id3.PROPERTYNAME }" validateAttr="allowNull=false;maxLength=10;"/><font style="color: red">*</font>
				</td>					
			</tr>
			<tr>	
				<td class="form_label" align="right" width="17%">产权人身份证号：</td>
				<td colspan="1" width="30%">
				<h:text id="propertyCardNo"  iterateId="id3" property="mortgageReserveHouse.propertyCardNo" value="${id3.PROPERTYCARDNO }" validateAttr="allowNull=false;maxLength=18;"/><font style="color: red">*</font>
				</td>	
				<td class="form_label" align="right" width="15%">产权地址：</td>
				<td colspan="1" width="30%">
				<h:text id="propertyAddres"  iterateId="id3" property="mortgageReserveHouse.propertyAddres" value="${id3.PROPERTYADDRES }" validateAttr="allowNull=false;maxLength=125;"/><font style="color: red">*</font>
				</td>					
			</tr>
			<tr>	
				<td class="form_label" align="right" width="15%">产权证本数：</td>
				<td colspan="1" width="30%">
				<h:text id="propertyNums"  size="5"  iterateId="id3" property="mortgageReserveHouse.propertyNums" value="${id3.PROPERTYNUMS }" validateAttr="allowNull=false;type=naturalNumber;maxLength=5;"/><font style="color: red">*</font>
				</td>	
